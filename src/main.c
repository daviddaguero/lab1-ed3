...
int main(int argc, char *argv[])
{
    ...
    emergency_msg = create_message("emergency", "Usuario1", "Usuario2", "español", "Se acerca el deadline del lab1", FLAG_URGENT | FLAG_CONFIDENTIAL, 0, 0);
    ...
    location_message = create_message("location", "Lujan", "David", "ingles", "Sending my location", FLAG_CONFIDENTIAL, 12, 26);
